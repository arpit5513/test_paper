    ...
    <div class="card card-outline card-primary rounded-0 shadow">
        ...
        <div class="card-body">
            <div id="outprint">
                ...
                <!-- header for school name and logo start here  -->
                <div class="paper_header">
                    <img class="m-0 p-0 float-left" style="height:150px;width:150px;"src="../assets/img/logo.png" alt="schoollogo">
                    <h2 Class="m-0 text-center">Uma Memorial Public School </h2><br>
                    <p class="m-0 text-center">Dherahi, Lakhanpur, Varanasi</p>
                </div>
                <h4 class="m-0 text-center"><b>Subject-<?= isset($title) ? $title : "" ?></b></h4>
                ...
                <?php if($text > 0): ?>
                <hr>
                    <h5><b><?= $category[$current_category++]; ?></b> Answer the following question.</h5>
                    <hr>
                    <?php 
                    $i = 1;
