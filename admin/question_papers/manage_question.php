        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea type="text" name="question" id="question" class=" questions form-control form-control-sm rounded-0 summernote" required><?php echo isset($question) ? html_entity_decode($question) : ''; ?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <option value="1" <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>Single Choice Answere</option>
                    <option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Multiple Choice Answers</option>
                    <option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Answere the following question </option>
                    <option value="4" <?php echo isset($type) && $type == 4 ? 'selected' : '' ?>>True and False</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex w-100">
                    <div class="col-10"><b>Option</b></div>
                ...
                <div class="text-right">
                    <button class="btn btn-flat btn-default btn-sm border" id="add_choice_item" type="button"> <i class="fa fa-plus"></i> Add Option</button>
                </div>
            </div>
        </div>
...
<script>
	...
	$(document).ready(function(){
        ...
        $('#type').change(function(){
            ...
            $('#question .summernote').each (function(){
                if(type ==4){
                    $(this).find('textarea,text').attr('disable',true)
                    
                }else{
                    $(this).find('textarea,text').attr('disable',false)
                }
            })
        })
        // for true and false
